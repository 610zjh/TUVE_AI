...
- Zhong Jiaheng: 明确授权写 `workspace_human/meetings/` 和 `workspace_human/prd/`
...
- 关联 ADR: `workspace_human/meetings/adr/ADR-0001_tuve_ai_primary_openclaw_context_secondary.md`
